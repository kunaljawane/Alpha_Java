...
public class LL
{
	...
	public static void main(String[] args) {
        ...
        LL reversedList = list.reverseList();
        System.out.print("Reversed List with extra space: ");
        reversedList.printList();
        
        System.out.print("Reversed List with iterative method: ");
        list.itertiveReverse();
        list.printList();
